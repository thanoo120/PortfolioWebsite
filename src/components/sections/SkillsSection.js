          ...
          <div className="flex flex-wrap gap-2.5">
            {group.skills.map((skill) => {
              ...
              return (
                <span
                  key={skill.name}
                  className="inline-flex items-center gap-2 rounded-lg border border-cyan-300/20 bg-slate-800/70 px-3 py-2 text-sm text-slate-200 transition hover:-translate-y-0.5 hover:border-cyan-300/40"
                >
