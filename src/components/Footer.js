...
const Footer = () => {
  return (
    <footer className="lg:pl-24 relative z-10 mt-20 border-t border-primary/20">
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-primary/5 to-transparent"></div>
      <div className="max-w-7xl mx-auto px-6 sm:px-8 md:px-12 lg:px-16 xl:px-24 py-8 relative z-10">
